...
public class OAuth2ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/api/cities/**", "/api/counties/**", "/api/categories/**").hasAnyAuthority("ADMIN", "MANAGER")
                .antMatchers(HttpMethod.PUT,"/api/cities/**", "/api/counties/**", "/api/categories/**").hasAnyAuthority("ADMIN", "MANAGER")
